          ...
          {storyCards.map((card, index) => (
            ...
            >
              <div className="dream-card rounded-3xl overflow-hidden transition-all duration-700 hover:shadow-elevated hover:-translate-y-3">
                {/* Placeholder Image */}
                <div className="relative h-72 sm:h-80 overflow-hidden bg-gradient-to-br from-orange-200/30 to-orange-100/20 flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-6xl mb-2">📷</div>
                    <p className="text-sm text-textgray/60">Story Image</p>
                  </div>
