  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-0 animate-rotate-slow" style={{ animationDuration: '180s' }}>
          <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full opacity-5">
            ...
            <circle cx="200" cy="200" r="120" stroke="#FFAA88" strokeWidth="0.5" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p
          ref={arabicRef}
          className="font-arabic text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-orange-600 leading-relaxed mb-10 text-shadow-glow"
          dir="rtl"
        >
        ...
        <p
          ref={referenceRef}
          className="font-body text-sm text-orange-600/80 tracking-[0.2em] uppercase"
        >
          — Quran 30:21 —
        </p>
