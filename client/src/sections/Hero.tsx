      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div ref={bismillahRef} className="mb-10 animate-scale-breathe">
          <div className="inline-block">
            <p className="font-arabic text-5xl sm:text-6xl md:text-7xl text-orange-600 leading-relaxed mb-6 text-shadow-glow">
              بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ
            </p>
            <p className="font-body text-xs sm:text-sm text-orange-500/70 tracking-[0.2em] uppercase">
        ...
        >
          ...
          <span className="block text-orange-600 my-3 sm:my-0 sm:mx-6 text-3xl sm:text-4xl">&</span>
