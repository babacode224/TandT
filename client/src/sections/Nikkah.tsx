        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div ref={imageRef} className="relative">
            <div className="relative rounded-3xl overflow-hidden shadow-elevated dream-glow">
              ...
              {/* Placeholder Image */}
              <div className="w-full h-[500px] sm:h-[600px] bg-gradient-to-br from-orange-200/40 to-orange-100/30 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-7xl mb-2">💍</div>
                  <p className="text-sm text-textgray/60">Ceremony Image</p>
                </div>
              </div>
          ...
          <div ref={contentRef} className="lg:pl-8">
            ...
            <div className="mb-10 animate-item">
              ...
              <p className="font-display text-2xl text-orange-400 italic">
                A Sacred Covenant
              </p>
            </div>
            ...
            <div className="animate-item">
              <Button
                ...
                className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-6 rounded-full font-body text-sm tracking-wide transition-all duration-500 hover:shadow-lg hover:scale-105"
              >
            ...
            <div className="mt-12 pt-8 border-t border-orange-100 animate-item">
              <p className="font-arabic text-2xl text-orange-400 text-center leading-relaxed animate-pulse-glow">
